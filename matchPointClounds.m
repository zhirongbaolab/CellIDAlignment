function [matches1to2,cost]=matchPointClounds(pos_1,pos2,constraints)
...
%note this was important to performance when we relied on constraint
%optimization, I'm guessing it isnt now and it was  ahack hard coded for
%end timepoint
